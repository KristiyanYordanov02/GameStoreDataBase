...
using (var scope = app.Services.CreateScope())
{
    ...
    var games = new List<Game>
    {
        ...
        new Game { Id = Guid.NewGuid(), Name = "Dark Souls III", Price = 69.99m, Developer = "FromSoftware" },
        ...
        new Game { Id = Guid.NewGuid(), Name = "FIFA 23", Price = 39.99m, Developer = "EA Sports" },
